        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-6 sm:mb-8 max-w-3xl mx-auto px-4">
              Your trusted companion for a healthy, mindful, and joyful
              pregnancy experience. Access personalized care, nutrition
              guidance, and wellness support all in one place.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center px-4">
              <Link
                to="/prenatal"
                className="bg-purple-600 hover:bg-purple-700 text-white px-6 sm:px-8 py-3 rounded-lg font-semibold transition duration-300 transform hover:scale-105 text-center"
              >
                Start Your Journey
              </Link>
              <Link
                to="/profile"
                className="bg-white hover:bg-gray-50 text-purple-600 px-6 sm:px-8 py-3 rounded-lg font-semibold border-2 border-purple-600 transition duration-300 text-center"
              >
                View Profile
              </Link>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-base sm:text-lg text-gray-600 mb-6 sm:mb-8 leading-relaxed">
                At Hiranyagarbha Garbha Sanskar LLP, we bring together ancient
                wisdom with modern techniques to commemorate the origins of
                life. Prenatal care is essential for both the mother and the
                child. Our purpose is to support you through this transforming
                journey while protecting your and your child’s well-being, using
                the traditional Indian method of Garbha Sanskar, which
                translates to ‘education of mind inside the womb.’ We offer
                expert advice, supporting your overall health and the journey to
                motherhood. Your journey to parenthood starts here –
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to="/prenatal"
                  className="bg-purple-600 hover:bg-purple-700 text-white px-6 sm:px-8 py-3 rounded-lg font-semibold transition duration-300 text-center"
                >
                  Learn More
                </Link>
                <Link
            ...
            <div className="order-1 lg:order-2">
              <div className="relative">
                <div className="w-full h-64 sm:h-80 lg:h-96 bg-gradient-to-br from-pink-100 to-purple-100 rounded-2xl flex items-center justify-center overflow-hidden">
                  <div className="text-center">
                    <svg
                      className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 text-purple-600 mx-auto mb-4"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8 sm:pb-12 lg:pb-16">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-base sm:text-lg text-gray-600 mb-6 sm:mb-8 leading-relaxed">
              Creating Lasting Bonds. With Hiranyagarbha Garbha Sanskar LLP, set
              out on an enriching journey as a parent. Our personalized Garbha
              Sanskar care guarantees a positive and healthy relationship
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12">
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              ...
              <p className="text-gray-600 text-sm">
                Weeks 1-12: Foundation building, early development, and
                essential care
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              ...
              <p className="text-gray-600 text-sm">
                Weeks 13-26: Energy returns, baby grows rapidly, prepare for
                delivery
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              ...
              <p className="text-gray-600 text-sm">
                Weeks 27-40: Final preparations, birth planning, and newborn
                care
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
          <Link to="/prenatal" className="group">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-4">
                Comprehensive medical care and monitoring throughout your
                pregnancy journey
              </p>
          ...
          <Link to="/nutrition" className="group">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-4">
                Personalized meal plans and nutritional guidance for optimal
                health
              </p>
          ...
          <Link to="/wellness" className="group">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-4">
                Mindful practices, meditation, and emotional support for mothers
              </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="h-32 sm:h-40 lg:h-48 bg-gradient-to-br from-pink-200 to-purple-200 flex items-center justify-center">
                <svg
                  className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 text-pink-600"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div className="p-4 sm:p-5 lg:p-6">
                ...
                <p className="text-gray-600 text-xs sm:text-sm">
                  Gentle yoga poses designed specifically for pregnant women to
                  improve flexibility, strength, and relaxation.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="h-32 sm:h-40 lg:h-48 bg-gradient-to-br from-green-200 to-blue-200 flex items-center justify-center">
                <svg
                  className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 text-green-600"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div className="p-4 sm:p-5 lg:p-6">
                ...
                <p className="text-gray-600 text-xs sm:text-sm">
                  Balanced meals rich in essential nutrients like folic acid,
                  iron, calcium, and omega-3 for you and your baby.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="h-32 sm:h-40 lg:h-48 bg-gradient-to-br from-purple-200 to-pink-200 flex items-center justify-center">
                <svg
                  className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 text-purple-600"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div className="p-4 sm:p-5 lg:p-6">
                ...
                <p className="text-gray-600 text-xs sm:text-sm">
                  Guided meditation sessions to reduce stress, improve sleep,
                  and connect with your changing body.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="p-4 sm:p-5 lg:p-6">
                ...
                <p className="text-gray-600 text-xs sm:text-sm">
                  Comprehensive prenatal care with monitoring of both mother and
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="h-32 sm:h-40 lg:h-48 bg-gradient-to-br from-yellow-200 to-orange-200 flex items-center justify-center">
                <svg
                  className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 text-yellow-600"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div className="p-4 sm:p-5 lg:p-6">
                ...
                <p className="text-gray-600 text-xs sm:text-sm">
                  Connect with other expecting mothers for shared experiences,
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="h-32 sm:h-40 lg:h-48 bg-gradient-to-br from-red-200 to-pink-200 flex items-center justify-center">
                <svg
                  className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 text-red-600"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div className="p-4 sm:p-5 lg:p-6">
                ...
                <p className="text-gray-600 text-xs sm:text-sm">
                  Tools and resources to manage pregnancy emotions, anxiety, and
                ...
                <p className="text-gray-600 text-sm sm:text-base italic">
                  {dashboardData.clientReviews[1].review.length > 100
                    ? expanded2
                      ...
                      : dashboardData.clientReviews[1].review.substring(
                          0,
                          100,
                        ) + "..."
                    : dashboardData.clientReviews[1].review}
                ...
                <p className="text-gray-600 text-sm sm:text-base italic">
                  {dashboardData.clientReviews[2].review.length > 100
                    ? expanded3
                      ...
                      : dashboardData.clientReviews[2].review.substring(
                          0,
                          100,
                        ) + "..."
                    : dashboardData.clientReviews[2].review}
                ...
                <p className="text-gray-600 text-sm sm:text-base italic">
                  {dashboardData.clientReviews[3].review.length > 100
                    ? expanded4
                      ...
                      : dashboardData.clientReviews[3].review.substring(
                          0,
                          100,
                        ) + "..."
                    : dashboardData.clientReviews[3].review}
        ...
        <div className="text-center px-4">
          ...
          <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-6 sm:p-8 rounded-xl shadow-lg max-w-4xl mx-auto">
            ...
            <p className="text-purple-100 text-sm sm:text-base">
              Drinking plenty of water is crucial during pregnancy. Aim for at
              least 8-10 glasses per day to support your increased blood volume
        ...
        <iframe
          ...
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3738.1212125168386!2d75.0023156755216!3d20.46021410706267!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bd9550d24188fd7%3A0x31225d70186a5302!2sBapji%20Jeevandeep%20Multispeciality%20Hospital!5e0!3m2!1sen!2sin!4v1777567339254!5m2!1sen!2sin"
          width="600"
          height="450"
          allowfullscreen=""
          loading="lazy"
